...
public class GeneticAlgorithmConstants {
    ...
    public static final int NUMBER_OF_GENES = 1220; //add a 1 if co-evolving step size mutation
    ...
    public static final int VAR_LENGTH = 60; //for seperating rule from action value
    public static final int LINE_LENGTH = 61; //for rule creation loop
    ...
    public static final boolean ISFLOAT = false;
    public static final int DATA_SIZE = 30; //the amount of float point data values
    ...
    public static final boolean SPLIT_DATASET = false; //for training and then test
